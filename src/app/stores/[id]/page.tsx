    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav className="mb-6 text-sm">
        <ol className="flex items-center gap-2" style={{ color: 'var(--eco-warm-gray)' }}>
          ...
          <li>/</li>
          <li style={{ color: 'var(--eco-charcoal)' }}>{store.name}</li>
        </ol>
      </nav>

      {/* Hero Banner */}
      <AnimateOnScroll animation="fade-in-up">
        <div className="relative rounded-xl overflow-hidden" style={{ background: '#1B3A2D' }}>
          ...
          <div className="relative z-[1] p-8 sm:p-10">
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
              {/* Logo */}
              <div style={{ background: '#F8F5F0', borderRadius: '16px', padding: '12px' }}>
                <Image
              ...
              <div className="flex-1 text-center sm:text-left">
                <p className="eco-overline mb-2" style={{ color: 'rgba(248,245,240,0.6)' }}>
                  Store Profile
                </p>
                <h1
                  className="eco-display"
                  style={{ fontSize: '2.25rem', color: '#F8F5F0' }}
                >
                  {store.name}
                </h1>
                <p className="mt-1" style={{ color: 'rgba(248,245,240,0.6)' }}>
                ...
                <div className="flex flex-wrap items-center gap-2 mt-4 justify-center sm:justify-start">
                  ...
                  <span style={{ color: 'rgba(248,245,240,0.25)' }}>|</span>
      ...
      {store.description && (
        <AnimateOnScroll animation="fade-in">
          <div className="mt-10">
            <p className="eco-overline mb-3" style={{ color: 'var(--eco-warm-gray)' }}>
              About
            </p>
            <p style={{ color: 'var(--eco-charcoal)', lineHeight: 1.75, fontSize: '1.0625rem' }}>
              {store.description}
            </p>
          </div>
        </AnimateOnScroll>
      ...
      <AnimateOnScroll animation="slide-in-left">
        <div
          ...
          style={{ background: '#EDEAE4', borderRadius: '12px' }}
        >
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="space-y-1" style={{ color: 'var(--eco-charcoal)' }}>
                  {store.additionalLocations && store.additionalLocations.length > 0 && (
                    <p className="eco-overline" style={{ color: 'var(--eco-warm-gray)', fontSize: '0.6875rem' }}>
                ...
                {store.additionalLocations?.map((loc, i) => (
                  <div
                    ...
                    style={{ color: 'var(--eco-charcoal)', borderTop: '1px solid var(--eco-border)' }}
                  >
                    {loc.label && (
                      <p className="eco-overline" style={{ color: 'var(--eco-warm-gray)', fontSize: '0.6875rem' }}>
                        {loc.label}
                    ...
                    {loc.phone && (
                      <a
                        href={`tel:${loc.phone}`}
                        className="store-detail-link text-sm"
              ...
              <div className="space-y-2">
                {store.website && (
                  <a
                    ...
                    className="flex items-center gap-2 store-detail-link"
                    style={{ color: 'var(--eco-sage)' }}
                  >
                    <svg
                      className="w-5 h-5"
      ...
      {(store.instagram || store.facebook || store.twitter || store.tiktok || store.pinterest || store.youtube || store.linkedin) && (
        <AnimateOnScroll animation="slide-in-right">
          <div className="mt-10">
            <p className="eco-overline mb-4" style={{ color: 'var(--eco-warm-gray)' }}>
              Connect
            </p>
            <div className="flex gap-3">
              {store.instagram && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="store-social-icon flex items-center justify-center rounded-full"
                  style={{
                    width: '44px',
                    height: '44px',
      ...
      {/* Footer Bar */}
      <div
        className="mt-10 pt-4 flex items-center justify-between text-sm"
      ...
      >
        ...
        <Link
          href="/stores"
          className="store-detail-link font-medium"
          style={{ color: 'var(--eco-sage)' }}
        >
          ← Back to all stores
        </Link>
